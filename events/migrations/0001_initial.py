# Generated by Django 2.1 on 2018-08-21 00:56
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('authors', models.ManyToManyField(related_name='events', to=settings.AUTH_USER_MODEL, verbose_name='Autores')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('title', models.CharField(max_length=200, verbose_name='Título')),
                ('description', models.TextField(help_text='Paragráfo único com no máximo 50 palavras.', verbose_name='Resumo')),
                ('goal', models.TextField(verbose_name='Objetivo')),
                ('status', models.IntegerField(choices=[(1, 'Submetido'), (2, 'Aprovado'), (3, 'Não aprovado')], default=1, verbose_name='Status')),
                ('authors', models.ManyToManyField(related_name='experiments', to=settings.AUTH_USER_MODEL, verbose_name='Autores')),
            ],
            options={
